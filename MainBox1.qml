...
Rectangle {
    ...
    property int width_empty: Math.floor(mainBox1.width * 0.4)/10 // defines the size of the empty space in a row
    ...
    Rectangle {
        ...
        x: 0
        y: (mainBox1.height + 10) *box_index
        ...
        Rectangle{
            //x: 0
            //y: mainBox1.height *box_index + 20
            id: title
