...
Rectangle {
    ...
    property real green
    property real blue
    property variant titles: [  "Child_Instruct",
                                "Robot_Instruct",
                                "Extra_Behavior"]
    function colorSelection(ind, red, green, blue){
        if (box_index === 0 | box_index === 1){
            ...
            else if (ind === 3 | ind ===15){
                return('#008000')
            }
            else if (ind === 2 | ind === 15){
                return('#ffa600')
            }
            ...
            else if ((ind >= 19 & ind < 21) | (ind >= 23 & ind < 25)){
                return('#daa520')
            }
            else if ((ind >= 21 & ind < 23) | (ind >= 25 & ind < 27)){
                return('#b22222')
            }
            else if (ind >= 27){
                return('#2f4f4f')
    ...
    Rectangle {
        ...
        Row{
            spacing: 5
            x: titleHeight * 7/2  + buttonWidth * 2
            y: titleHeight * 3/2
            Repeater{
                id: row2
                model:3
                ActionButton{
                    ...
                    width: buttonWidth * 2/3
                    height: buttonHeight
                    color: colorSelection(index+15, red, green, blue)
                    hoverColor: hoverColorSelection(index+15, red, green, blue)
                    pressColor: pressColorSelection(index+15, red, green, blue)
                    buttonText: texMex [index+15]
                    columnNum: box_index
                    columnTitle: titles
                    title: titles[box_index]
                }
            ...
            Row{
                ...
                Repeater{
                    ...
                    ActionButton{
                        ...
                        width: buttonWidth
                        height: buttonHeight
                        color: colorSelection(index+18, red, green, blue)
                        hoverColor: hoverColorSelection(index+18, red, green, blue)
                        pressColor: pressColorSelection(index+18, red, green, blue)
                        buttonText: texMex [index+18]
                        columnNum: box_index
                        columnTitle: titles
                        title: titles[box_index]
                    }
            ...
            Row{
                ...
                Repeater{
                    ...
                    ActionButton{
                        ...
                        width: buttonWidth * 2/3
                        height: buttonHeight
                        color: colorSelection(index+27, red, green, blue)
                        hoverColor: hoverColorSelection(index+27, red, green, blue)
                        pressColor: pressColorSelection(index+27, red, green, blue)
                        buttonText: texMex [index+27]
                        columnNum: box_index
                        columnTitle: titles
                        title: titles[box_index]
                    }
            ...
            ActionButton{
                ...
                height: buttonHeight
                color: colorSelection(29, red, green, blue)
                hoverColor: hoverColorSelection(29, red, green, blue)
                pressColor: pressColorSelection(29, red, green, blue)
                buttonText: texMex [29]
                columnNum: box_index
                columnTitle: titles
                title: titles[box_index]
            }
